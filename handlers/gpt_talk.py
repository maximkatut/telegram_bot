...
async def process_question(message: Message, state: FSMContext):
    ...
    gpt_service.set_system_message(
        f'You will be a famous person {message.text}. I would like to talk to you. '
        f'I will ask some questions about you and your life.')
...
@gpt_talk_router.callback_query(gpt_talk_callback.filter(F.name == 'talk'))
